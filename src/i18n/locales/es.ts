...
const es: Record<TranslationKeys, string> = {
  ...
  "patientNav.home": "Inicio",
  "patientNav.appointments": "Consultas",
  "patientNav.urgentCare": "Urgencias",
  "patientNav.schedule": "Agendar",
  "patientNav.health": "Mi Salud",
  "patientNav.prescriptions": "Recetas",
  "patientNav.examResults": "Exámenes",
  "patientNav.uploadExams": "Subir Exámenes",
  "patientNav.renewal": "Renovar Receta",
  "patientNav.payments": "Pagos",
  "patientNav.notifications": "Avisos",
  "patientNav.support": "Soporte",
  "patientNav.chat": "Chat",
  "patientNav.profile": "Mi Perfil",
  "patientNav.settings": "Ajustes",
  "patientNav.privacy": "Privacidad",
  "patientNav.groupMain": "Principal",
  "patientNav.groupHealth": "Salud Digital",
  "patientNav.groupFinance": "Facturación y Alertas",
  "patientNav.groupAccount": "Cuenta",

  "appt.scheduled": "Agendada",
  "appt.confirmed": "Confirmada",
  "appt.inProgress": "En curso",
  "appt.completed": "Completada",
  "appt.cancelled": "Cancelada",
  "appt.noShow": "No asistió",

  "book.selectSpecialty": "Seleccione especialidad",
  "book.selectDoctor": "Elija médico",
  "book.selectSlot": "Elija horario",
  "book.confirmBooking": "Confirmar reserva",
  "book.paymentMethod": "Método de pago",
  "book.total": "Total",

  "dashboardPatient.greetingMorning": "Buenos días",
  "dashboardPatient.greetingAfternoon": "Buenas tardes",
  "dashboardPatient.greetingEvening": "Buenas noches",
  "dashboardPatient.howAreYou": "¿Cómo te sientes hoy?",
  "dashboardPatient.bookNow": "Agendar ahora",
  "dashboardPatient.urgentNow": "Atención inmediata",
