...
vi.mock("@/assets/spec-alergia.png", () => ({ default: "sp.png" }));
vi.mock("@/assets/spec-angiologia.png", () => ({ default: "sp.png" }));
vi.mock("@/assets/spec-cirurgia.png", () => ({ default: "sp.png" }));
vi.mock("@/assets/spec-coloproctologia.png", () => ({ default: "sp.png" }));
...
vi.mock("@/assets/spec-hematologia.png", () => ({ default: "sp.png" }));
vi.mock("@/assets/spec-infectologia.png", () => ({ default: "sp.png" }));
vi.mock("@/assets/spec-mastologia.png", () => ({ default: "sp.png" }));
vi.mock("@/assets/spec-familia.png", () => ({ default: "sp.png" }));
vi.mock("@/assets/spec-esporte.png", () => ({ default: "sp.png" }));
...
vi.mock("@/assets/spec-radiologia.png", () => ({ default: "sp.png" }));
vi.mock("@/assets/spec-reumatologia.png", () => ({ default: "sp.png" }));
vi.mock("@/assets/spec-urologia.png", () => ({ default: "sp.png" }));
vi.mock("@/assets/spec-anestesiologia.png", () => ({ default: "sp.png" }));
vi.mock("@/assets/spec-endoscopia.png", () => ({ default: "sp.png" }));
vi.mock("@/assets/spec-genetica.png", () => ({ default: "sp.png" }));
vi.mock("@/assets/spec-homeopatia.png", () => ({ default: "sp.png" }));
vi.mock("@/assets/spec-plastica.png", () => ({ default: "sp.png" }));
vi.mock("@/assets/spec-cirurgia-cardio.png", () => ({ default: "sp.png" }));
vi.mock("@/assets/spec-intensiva.png", () => ({ default: "sp.png" }));
vi.mock("@/assets/spec-cabeca-pescoco.png", () => ({ default: "sp.png" }));
vi.mock("@/assets/spec-cirurgia-vascular.png", () => ({ default: "sp.png" }));
